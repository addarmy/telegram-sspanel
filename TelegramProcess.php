...
/delnode <节点ID> - 删除节点";
    ...
    public static function process()
    {
        try {
            ...
            $command_list = array("ping", "chat", "help", "prpr", "checkin", "setclass", "setdate", "setmoney", "setconnector", "setrole", "setspeed", "generatecode", "delnode", "info", "sub", "nodes", "store", "buy", "redeem", "my", "invite", "store", "buy", "ban", "active", "find", "topip", "toptr");
